  ...
  LolClient = (function(_super) {
    ...
    function LolClient(options) {
      ...
      this.keepAlive = function(cb) {
        return LolClient.prototype.keepAlive.apply(_this, arguments);
      };
      this.getAllLeaguesForPlayer = function(summoner_id, cb) {
        return LolClient.prototype.getAllLeaguesForPlayer.apply(_this, arguments);
      };
      this.getMasteryBook = function(summoner_id, cb) {
        return LolClient.prototype.getMasteryBook.apply(_this, arguments);
      };
      this.getSpectatorInfo = function(name, cb) {
        return LolClient.prototype.getSpectatorInfo.apply(_this, arguments);
      };
      this.getSummonerName = function(name, cb) {
        return LolClient.prototype.getSummonerName.apply(_this, arguments);
      };
      this.getSummonerData = function(account_id, cb) {
        return LolClient.prototype.getSummonerData.apply(_this, arguments);
      };
      this.getTeamById = function(team_id, cb) {
        return LolClient.prototype.getTeamById.apply(_this, arguments);
      };
      this.getTeamsForSummoner = function(summoner_id, cb) {
        return LolClient.prototype.getTeamsForSummoner.apply(_this, arguments);
      };
      this.getAggregatedStats = function(account_id, cb) {
        return LolClient.prototype.getAggregatedStats.apply(_this, arguments);
      };
      this.getMatchHistory = function(account_id, cb) {
        return LolClient.prototype.getMatchHistory.apply(_this, arguments);
      };
      this.getSummonerStats = function(account_id, cb) {
        return LolClient.prototype.getSummonerStats.apply(_this, arguments);
      };
      this.getSummonerByName = function(name, cb) {
        return LolClient.prototype.getSummonerByName.apply(_this, arguments);
      };
      this.performAuth = function(result) {
        return LolClient.prototype.performAuth.apply(_this, arguments);
      };
      this.performLogin = function(result) {
        return LolClient.prototype.performLogin.apply(_this, arguments);
      };
    ...
    LolClient.prototype.performAuth = function(result) {
      ...
      return this.rtmp.send(cmd, function(err, result) {
        if (err) {
          ...
          if (_this.options.debug) {
            logger.info('lol-client: Connect Process Completed');
          }
