...
(function() {
  var ASObject, AggregatedStatsPacket, AuthPacket, ConnectPacket, Decoder, Encoder, GetAllLeaguesForPlayerPacket, GetMasteryBookPacket, GetSpectatorInfoPacket, GetSummonerDataPacket, GetSummonerNamePacket, GetTeamByIdPacket, GetTeamForSummonerPacket, HeartbeatPacket, LoginPacket, LookupPacket, Packet, PlayerStatsPacket, RecentGamesPacket, uuid,
  ...
  ConnectPacket = (function(_super) {
    ...
    function ConnectPacket() {
      ConnectPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  AuthPacket = (function(_super) {
    ...
    function AuthPacket() {
      AuthPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  HeartbeatPacket = (function(_super) {
    ...
    function HeartbeatPacket() {
      HeartbeatPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  LookupPacket = (function(_super) {
    ...
    function LookupPacket() {
      LookupPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  GetSummonerDataPacket = (function(_super) {
    ...
    function GetSummonerDataPacket() {
      GetSummonerDataPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  AggregatedStatsPacket = (function(_super) {
    ...
    function AggregatedStatsPacket() {
      AggregatedStatsPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  PlayerStatsPacket = (function(_super) {
    ...
    function PlayerStatsPacket() {
      PlayerStatsPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  RecentGamesPacket = (function(_super) {
    ...
    function RecentGamesPacket() {
      RecentGamesPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  GetTeamForSummonerPacket = (function(_super) {
    ...
    function GetTeamForSummonerPacket() {
      GetTeamForSummonerPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  GetTeamByIdPacket = (function(_super) {
    ...
    function GetTeamByIdPacket() {
      GetTeamByIdPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  GetSummonerNamePacket = (function(_super) {
    ...
    function GetSummonerNamePacket() {
      GetSummonerNamePacket.__super__.constructor.apply(this, arguments);
    }
  ...
  GetSpectatorInfoPacket = (function(_super) {
    ...
    function GetSpectatorInfoPacket() {
      GetSpectatorInfoPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  GetMasteryBookPacket = (function(_super) {
    ...
    function GetMasteryBookPacket() {
      GetMasteryBookPacket.__super__.constructor.apply(this, arguments);
    }
  ...
  GetAllLeaguesForPlayerPacket = (function(_super) {

    __extends(GetAllLeaguesForPlayerPacket, _super);

    function GetAllLeaguesForPlayerPacket() {
      GetAllLeaguesForPlayerPacket.__super__.constructor.apply(this, arguments);
    }

    GetAllLeaguesForPlayerPacket.prototype.generate = function(summoner_id) {
      var object;
      object = new ASObject();
      object.name = 'flex.messaging.messages.RemotingMessage';
      object.keys = ['source', 'operation', 'timestamp', 'messageId', 'clientId', 'timeToLive', 'body', 'destination', 'headers'];
    ...
    GetAllLeaguesForPlayerPacket.prototype.generateHeaders = function() {
      var headers;
      headers = new ASObject();
      headers.name = '';
      headers.object = {
    ...
    return GetAllLeaguesForPlayerPacket;
