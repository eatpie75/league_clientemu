...
(function() {
  ...
  SubscribePacket = (function(_super) {
    __extends(SubscribePacket, _super);

    function SubscribePacket() {
      return SubscribePacket.__super__.constructor.apply(this, arguments);
    }

    SubscribePacket.prototype.generate = function(body_string, header_string) {
      var object;
      object = new ASObject();
      object.name = 'flex.messaging.messages.CommandMessage';
      object.keys = ['operation', 'correlationId', 'timestamp', 'clientId', 'timeToLive', 'messageId', 'destination', 'headers', 'body'];
      object.object = {
        ...
        headers: this.generateHeaders(header_string),
        body: {}
      };
      object.encoding = 0;
      return object;
    ...
    SubscribePacket.prototype.generateHeaders = function(header_string) {
      var headers;
      headers = new ASObject();
      headers.name = '';
      headers.object = {
  ...
  GetAllLeaguesForPlayerPacket = (function(_super) {
    ...
    function GetAllLeaguesForPlayerPacket() {
      return GetAllLeaguesForPlayerPacket.__super__.constructor.apply(this, arguments);
    }
