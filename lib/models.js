...
(function() {
  var Leagues, MasteryBook, PlayerNames, PlayerStats, RecentGames, RunePage, Search, SpectatorInfo, Summoner, cmp, get_object_index, group_by, has_key, json, util,
  ...
  get_object_index = function(array, key, value) {
    var i, row, _i, _len;
    i = 0;
    for (_i = 0, _len = array.length; _i < _len; _i++) {
      row = array[_i];
      if (has_key(row, key) && row[key] === value) {
        return i;
        break;
      } else {
        i += 1;
