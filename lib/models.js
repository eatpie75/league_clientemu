...
(function() {
  ...
  PlayerNames = (function() {
    function PlayerNames(_at_cb, options) {
      this.cb = _at_cb;
    ...
    PlayerNames.prototype.get = function(args) {
      ...
      return this.client.getSummonerName(this.summoners, (function(_this) {
  ...
  PlayerStats = (function() {
    function PlayerStats(_at_cb, options) {
      this.cb = _at_cb;
    ...
    PlayerStats.prototype.get = function(args) {
      ...
      return this.client.getSummonerStats(account_id, (function(_this) {
        return function(err, result) {
          var data;
          if (err != null) {
            data = err;
  ...
  RecentGames = (function() {
    function RecentGames(_at_cb, options) {
      this.cb = _at_cb;
      this.toJSON = __bind(this.toJSON, this);
      this.get = __bind(this.get, this);
      this.parse = __bind(this.parse, this);
    ...
    RecentGames.prototype.get = function(args) {
      var account_id;
      account_id = args.account_id;
      return this.client.getMatchHistory(account_id, (function(_this) {
        return function(err, result) {
          var data;
          if (err != null) {
  ...
  Summoner = (function() {
    function Summoner(_at_cb, options) {
      this.cb = _at_cb;
      this.toJSON = __bind(this.toJSON, this);
      this.get = __bind(this.get, this);
      this.parse = __bind(this.parse, this);
    ...
    Summoner.prototype.get = function(args) {
      ...
      found_account_id = (function(_this) {
        return function() {
          return _this.client.getSummonerData(_this.account_id, function(err, result) {
            var extra, _ref, _ref1;
            if (err != null) {
              _this.data = err;
            } else if ((result == null) || (((_ref = result.object.summoner.object.acctId) != null ? _ref.value : void 0) == null)) {
              _this.data = {
                'error': 'RETRY'
              };
            } else {
            ...
            if (_this.runes && (((_ref1 = _this.org) != null ? _ref1.object : void 0) != null)) {
      ...
      if (has_key(args, 'account_id')) {
        ...
        return this.client.getSummonerByName(args.name, (function(_this) {
          return function(err, result) {
            var banned_ids;
            _this.requests += 1;
            if (err != null) {
  ...
  Leagues = (function() {
    function Leagues(_at_cb, options) {
      this.cb = _at_cb;
      this.toJSON = __bind(this.toJSON, this);
      this.get = __bind(this.get, this);
      this.parse = __bind(this.parse, this);
    ...
    Leagues.prototype.parse = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        entries[league.requestorsRank].sort((function(_this) {
          return function(a, b) {
    ...
    Leagues.prototype.get = function(args) {
      ...
      return this.client.getAllLeaguesForPlayer(summoner_id, (function(_this) {
        return function(err, result) {
          var _ref, _ref1;
          if (err != null) {
            _this.data = err;
            ...
            _this.data = {};
          } else if ((result == null) || (((_ref = result.object) != null ? (_ref1 = _ref.summonerLeagues) != null ? _ref1.data : void 0 : void 0) == null)) {
            _this.data = {
              'error': 'RETRY'
            };
          } else {
  ...
  Search = (function() {
    function Search(_at_cb, options) {
      this.cb = _at_cb;
      this.toJSON = __bind(this.toJSON, this);
      this.get = __bind(this.get, this);
      this.parse = __bind(this.parse, this);
    ...
    Search.prototype.get = function(args) {
      var name;
      name = args.name;
      return this.client.getSummonerByName(name, (function(_this) {
        return function(err, result) {
          if (err != null) {
            _this.data = err;
          } else if (err === null && result === null) {
  ...
  MasteryBook = (function() {
    function MasteryBook(_at_cb, options) {
      this.cb = _at_cb;
      this.toJSON = __bind(this.toJSON, this);
      this._msort = __bind(this._msort, this);
      this.get = __bind(this.get, this);
    ...
    MasteryBook.prototype.get = function(args) {
      ...
      this.account_id = args.account_id;
      return this.client.getMasteryBook(this.summoner_id, (function(_this) {
        return function(err, result) {
          if (err != null) {
            _this.data = err;
          } else {
  ...
  SpectatorInfo = (function() {
    function SpectatorInfo(_at_cb, options) {
      this.cb = _at_cb;
      this.toJSON = __bind(this.toJSON, this);
      this.get = __bind(this.get, this);
      this.parse = __bind(this.parse, this);
    ...
    SpectatorInfo.prototype.get = function(args) {
      var name;
      name = args.name;
      return this.client.getSpectatorInfo(name, (function(_this) {
        return function(err, result) {
