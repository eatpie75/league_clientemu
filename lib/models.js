...
(function() {
  var Leagues, MasteryBook, PlayerNames, PlayerStats, RecentGames, RunePage, Search, SpectatorInfo, Summoner, cmp, group_by, has_key, index_of_object, json, logger,
    _this = this;
  ...
  PlayerNames = (function() {
    ...
    function PlayerNames(cb, options) {
      ...
      this.get = function(args) {
        return PlayerNames.prototype.get.apply(_this, arguments);
      };
      this.parse = function() {
        return PlayerNames.prototype.parse.apply(_this, arguments);
      };
      if (options != null) {
  ...
  PlayerStats = (function() {
    ...
    function PlayerStats(cb, options) {
      ...
      this.toJSON = function() {
        return PlayerStats.prototype.toJSON.apply(_this, arguments);
      };
      this.get = function(args) {
        return PlayerStats.prototype.get.apply(_this, arguments);
      };
      this.parse = function() {
        return PlayerStats.prototype.parse.apply(_this, arguments);
      };
      if (options != null) {
        if (options.hasOwnProperty('client')) {
          this.client = options.client;
  ...
  RecentGames = (function() {
    ...
    function RecentGames(cb, options) {
      ...
      this.cb = cb;
      this.toJSON = function() {
        return RecentGames.prototype.toJSON.apply(_this, arguments);
      };
      this.get = function(args) {
        return RecentGames.prototype.get.apply(_this, arguments);
      };
      this.parse = function() {
        return RecentGames.prototype.parse.apply(_this, arguments);
      };
      if (options.hasOwnProperty('client')) {
        this.client = options.client;
      }
    ...
    RecentGames.prototype.parse = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _ref2 = ['num_deaths', 'champions_killed', 'assists', 'largest_critical_strike', 'largest_killing_spree', 'largest_multi_kill', 'item0', 'item1', 'item2', 'item3', 'item4', 'item5', 'minions_killed', 'neutral_minions_killed', 'gold_earned', 'physical_damage_dealt_player', 'magic_damage_dealt_player', 'physical_damage_dealt_to_champions', 'magic_damage_dealt_to_champions', 'total_damage_dealt', 'total_damage_dealt_to_champions', 'physical_damage_taken', 'magic_damage_taken', 'total_damage_taken', 'total_heal', 'total_time_spent_dead', 'turrets_killed', 'inhibitors_destroyed', 'lose', 'win', 'sight_wards_bought_in_game', 'vision_wards_bought_in_game', 'node_neutralize', 'node_neutralize_assist', 'node_capture', 'node_capture_assist', 'victory_point_total', 'team_objective', 'objective_player_score', 'combat_player_score', 'total_player_score', 'total_score_rank'];
  ...
  Summoner = (function() {
    ...
    function Summoner(cb, options) {
      ...
      this.cb = cb;
      this.toJSON = function() {
        return Summoner.prototype.toJSON.apply(_this, arguments);
      };
      this.get = function(args) {
        return Summoner.prototype.get.apply(_this, arguments);
      };
      this.parse = function() {
        return Summoner.prototype.parse.apply(_this, arguments);
      };
      if (options != null) {
        if (options.hasOwnProperty('client')) {
          this.client = options.client;
  ...
  Leagues = (function() {
    ...
    function Leagues(cb, options) {
      ...
      this.cb = cb;
      this.toJSON = function() {
        return Leagues.prototype.toJSON.apply(_this, arguments);
      };
      this.get = function(args) {
        return Leagues.prototype.get.apply(_this, arguments);
      };
      this.parse = function() {
        return Leagues.prototype.parse.apply(_this, arguments);
      };
      if (options != null) {
  ...
  Search = (function() {
    ...
    function Search(cb, options) {
      ...
      this.cb = cb;
      this.toJSON = function() {
        return Search.prototype.toJSON.apply(_this, arguments);
      };
      this.get = function(args) {
        return Search.prototype.get.apply(_this, arguments);
      };
      this.parse = function() {
        return Search.prototype.parse.apply(_this, arguments);
      };
      if (options != null) {
        if (has_key(options, 'client')) {
          this.client = options.client;
    ...
    Search.prototype.parse = function() {
      var current;
      logger.info('models: search: ', this.search);
      this.data = {};
      current = {
  ...
  RunePage = (function() {
    ...
    function RunePage(options) {
      var _this = this;
      this.toJSON = function() {
        return RunePage.prototype.toJSON.apply(_this, arguments);
      };
      this._rsort = function(a, b) {
        return RunePage.prototype._rsort.apply(_this, arguments);
      };
      this._msort = function(a, b) {
        return RunePage.prototype._msort.apply(_this, arguments);
      };
      this.parse = function() {
        return RunePage.prototype.parse.apply(_this, arguments);
      };
      if (options != null) {
        if (has_key(options, 'client')) {
          this.client = options.client;
  ...
  MasteryBook = (function() {
    ...
    function MasteryBook(cb, options) {
      ...
      this.cb = cb;
      this.toJSON = function() {
        return MasteryBook.prototype.toJSON.apply(_this, arguments);
      };
      this._msort = function(a, b) {
        return MasteryBook.prototype._msort.apply(_this, arguments);
      };
      this.get = function(args) {
        return MasteryBook.prototype.get.apply(_this, arguments);
      };
      this.parse = function() {
        return MasteryBook.prototype.parse.apply(_this, arguments);
      };
      if (options != null) {
        if (has_key(options, 'client')) {
          this.client = options.client;
  ...
  SpectatorInfo = (function() {
    ...
    function SpectatorInfo(cb, options) {
      ...
      this.cb = cb;
      this.toJSON = function() {
        return SpectatorInfo.prototype.toJSON.apply(_this, arguments);
      };
      this.get = function(args) {
        return SpectatorInfo.prototype.get.apply(_this, arguments);
      };
      this.parse = function() {
        return SpectatorInfo.prototype.parse.apply(_this, arguments);
      };
      if (options != null) {
        if (has_key(options, 'client')) {
          this.client = options.client;
