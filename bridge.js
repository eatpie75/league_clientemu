...
(function() {
  var af_app, app, bridge_status_middleware, child_process, client, client_exited, client_restart, debug, express, http, id, initial, instance, logger, lolclient_middleware, mode, options, path, port, routes, server_id_middleware, server_list, start_client, status;
