...
(function() {
  var AMF0Decoder, AMF0Encoder, RTMPClient, RTMPCommand, RTMPHeader, RTMPMessage, RTMPProtocol, assert, events, hexy,
      ...
      while (offset < data.length) {
        ...
        if (hdrtype < RTMPHeader.TIME) {
          ...
          try {
            ...
            console.log('150:data.copy(sizeData, 1, offset, offset+3)');
            console.log(e);
            console.log("sizeData:" + sizeData + ", offset:" + offset);
          }
          offset += 3;
      ...
      if (this.partialMessage) {
        ...
        if (hdrtype < RTMPHeader.TIME) {
          ...
          try {
            ...
            console.log('360:data.copy(sizeData, 1, offset, offset+3)');
            console.log(e);
            console.log("sizeData:" + sizeData + ", offset:" + offset);
          }
          offset += 3;
      ...
      while (offset < data.length) {
        ...
        if (packetData.length < header.size) {
          ...
          if (msg.type === RTMPMessage.ACK) {
            console.log('rtmp.coffee:589:msg.type==RTMPMessage.ACK');
          ...
          if (tmp.object.hasOwnProperty('rootCause')) {
            if (tmp.object.rootCause.object.errorCode === 'LOGIN-0007') {
              ...
              if (tmp.object.rootCause.object.message === 'Game is not observable ') {
                console.log('Game not observable');
                cmd.args.push({
                  error: 'OB-2'
                });
