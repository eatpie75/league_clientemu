...
(function() {
  var AMFContext, ASObject, ClassDefinition, Decoder, Encoder, Float, MAX_29B_INT, MIN_29B_INT, ObjectEncoding, REFERENCE_BIT, TYPE_ARRAY, TYPE_BOOL_FALSE, TYPE_BOOL_TRUE, TYPE_BYTEARRAY, TYPE_DATE, TYPE_INTEGER, TYPE_NULL, TYPE_NUMBER, TYPE_OBJECT, TYPE_STRING, TYPE_UNDEFINED, TYPE_XML, TYPE_XMLSTRING, logger, typeOf,
  ...
  ClassDefinition = (function() {
    ...
    ClassDefinition.prototype.initialize = function(_at_alias) {
      this.alias = _at_alias;
  ...
  Decoder = (function(_super) {
    ...
    function Decoder(_at_buffer, _at_offset) {
      this.buffer = _at_buffer;
      this.offset = _at_offset != null ? _at_offset : 0;
    ...
    Decoder.prototype.readObject = function() {
      var classData, encodingRef, idx, klass, name, object, ref, thing, _ref;
      ref = this.readInteger(false);
      object = null;
      ...
      if (ref & 1) {
        if (ref & 2) {
          if (ref & 4) {
            ...
            if ((_ref = klass.name) === 'com.riotgames.platform.systemstate.ClientSystemStatesNotification' || _ref === 'DSA') {
              return object;
            }
    ...
    Decoder.prototype._getClassDefinition = function(ref) {
      var AcknowledgeMessage, ArrayCollection, AsyncMessage, isRef, name, thing;
      ...
      } else if (name === 'com.riotgames.platform.broadcast.BroadcastNotification') {

      } else if (name === 'com.riotgames.platform.systemstate.ClientSystemStatesNotification') {

      } else if (name === 'DSA') {
        AsyncMessage = require('./messaging').AsyncMessage;
        thing = new AsyncMessage();
        logger.info('amf3: dsa packet');
      } else {
        logger.info('amf3: unknown packet:', name);
      }
      this.addClass(name, thing);
      return thing;
    };
  ...
  Encoder = (function(_super) {
    ...
    function Encoder(_at_buffer, _at_offset) {
      this.buffer = _at_buffer;
      this.offset = _at_offset != null ? _at_offset : 0;
      if (!this.buffer) {
